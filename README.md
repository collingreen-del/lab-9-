...
it acts like a wildcard of sorts, and removes the need to manually list all signals; this reduces the number of errors that migjt occur from manuallu checking all inputs.

### What importance is memory to digital circuits?
it allows them to store previous or past instructions and data; which means it can do more than just act on present information or instructions. 
